...
import cn.demo.random.annotations.CurrentUser;
import cn.demo.random.config.AppProperties;
import cn.demo.random.security.CustomUser;
import cn.demo.random.util.MailService;
...
public class ExampleController{
    ...
    @RequestMapping
    public Object home(@CurrentUser CustomUser principal){
    	...
    	mailService.sendActivatioEmail(principal.getRbacUser(), "http://www.baidu.com");
